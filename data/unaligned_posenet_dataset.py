...
class UnalignedPoseNetDataset(BaseDataset):
    ...
    def __getitem__(self, index):   ## A_paths : Dataset image path index,  index
        ...
        ## 참고 : https://discuss.pytorch.org/t/how-to-retrieve-the-sample-indices-of-a-mini-batch/7948
        return {'index_N' : index_A,   ## Dataset index 값 같이 리턴
                'A': A, 'B': A_pose,
                'A_paths': A_path}
